...
for PARALLEL_SETTING in [True, False]:
    ...
    for QUERY_HARDNESS, OOD in [(None, True), (None, False)]:
        HIGH_DIM = None
    #for QUERY_HARDNESS, OOD, HIGH_DIM in [(None, None, True), (None, None, False)]:
        ...
        if PARALLEL_SETTING:
            data_dir = "./fig/max_rec_vaq_hnsw_parallel"
            out_path = f"./fig/max_rec_vaq_hnsw_parallel/summary{postfix}.csv"
        else:
            data_dir = "./fig/max_rec_vaq_hnsw_sequential"
            out_path = f"./fig/max_rec_vaq_hnsw_sequential/summary{postfix}.csv"
